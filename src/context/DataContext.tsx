...
export const normalizePortfolioItems = (items: any[]): PortfolioProject[] => {
  ...
  return items.map((p, idx) => ({
    ...
    coverImage: p.coverImage || p.headerImage || '',
...
export const INITIAL_DATA: AppDataState = {
  global_settings: {
    ...
    aboutTitle: 'من هو أحمد سامح؟',
    jobTitle: 'صانع محتوى ومطور تجارب رقمية',
    aboutSubtitle: 'الحركة هي عالمي • والذكاء الرقمي أداتي',
    philosophyTitle: 'فلسفة "الحركة هي عالمي"',
    philosophyDescription: 'الحركة ليست مجرد انتقال من نقطة لأخرى، بل هي الإيقاع الذي يحرك القصة في الفيديو، والسرعة التي تحل خوارزميات التحدي، والتفاعل الإنساني الحي الذي يجعل التجارب الرقمية تنبض بالحياة.',
  },
  services: [
    {
      id: 'srv-1',
  ...
  about_projects: [
    {
      id: 'ab-1',
      title: 'منصة الحركة والتجارب التفاعلية',
      status: 'جاري العمل عليه',
      description: 'بناء منصة تفاعلية تجمع بين الإبداع البصري في الفيديو وحلول البرمجة السريعة والذكاء الاصطناعي.',
      link: '',
      order: 1,
    },
    {
      id: 'ab-2',
      title: 'سلسلة حلول الروبيك والتقنية السريعة',
      status: 'مكتمل',
      description: 'سلسلة محتوى رقمي تركز على خوارزميات التفكير السريع وصناعة تجارب تعليمية بصرية حديثة.',
      link: '',
      order: 2,
    },
  ],
